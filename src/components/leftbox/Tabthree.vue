    ...
    <div class="box">
        ...
        <div class="rightdata">
            <div class="footer">
                ...
                <input class="input" type="Text2" placeholder="添加任务" v-model="inputValue" @focus="startAnimation"
                    @blur="resetProgress" @keyup.enter="handleEnterKey" />
                <div class="jindu">
                    <el-progress :percentage="progressValue" color="#1089ff" :show-Text2="false"
...
export default {
    ...
    mounted() {
        // 从本地存储中获取数据
        const storedItems = localStorage.getItem("Text2");
        if (storedItems) {
    ...
    methods: {
        del(index) {
            ...
            localStorage.setItem("Text2", JSON.stringify(this.tet2));
        },
        startAnimation() {
