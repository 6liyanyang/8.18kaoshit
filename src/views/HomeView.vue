<template>
  <div>
    <div class="todoicon" @click="qiehuan">
      <img :src="imger" alt width="100%" height="100%" />
      <span>待办事项</span>
    </div>
    <div :class="{ 'largepage': Size, 'app': !Size }" v-if="apptext">
      <div id="icon" @click="togglePageSize">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="8" height="8"
          viewBox="0 0 11 11" fill="none" class="d-middle" v-if="iconxxx">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="8"
          height="2.399993896484375" viewBox="0 0 12 2.399993896484375" fill="none" class="d-middle" id="min-icon"
          v-if="iconx">
          <path id="矩形" fill-rule="evenodd" opacity="1"
            d="M1 2.4L11 2.4C11.55 2.4 12 1.95 12 1.4L12 1C12 0.45 11.55 0 11 0L1 0C0.45 0 0 0.45 0 1L0 1.4C0 1.95 0.45 2.4 1 2.4Z"
            style="fill: rgb(255, 255, 255);" />
        </svg>
      </div>
      <div id="icon1" @click="guanbi">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="8" height="8"
          viewBox="0 0 11 11" fill="none" class="d-middle">
...
<script>
import lefts from "../components/leftbox/leftbox.vue";
...
export default {
  ...
  data() {
    return {
      imger: "https://files.codelife.cc/icons/todo.svg",
  ...
  methods: {
    ...
    togglePageSize() {
      this.Size = !this.Size; // 切换页面大小
      this.iconxxx = !this.iconxxx;
      this.iconx = !this.iconx;
    },
    guanbi() {
      this.apptext = false;
    }
